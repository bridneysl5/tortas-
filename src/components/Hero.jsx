...
import tortaImg from '../img/torta banner inicio.png';

export default function Hero() {
  return (
    <section id="inicio" className="relative overflow-hidden py-16 lg:py-24 border-b border-sweetpink/40">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="w-full lg:w-7/12 flex flex-col text-center lg:text-left">
          ...
          <div className="hidden lg:flex w-full lg:w-5/12 justify-center">
